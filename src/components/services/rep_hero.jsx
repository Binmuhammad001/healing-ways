    ...
    <section className="relative min-h-[70vh] md:min-h-[85vh] flex items-center justify-start overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 md:px-12 max-w-7xl">
        <div className="max-w-full md:max-w-2xl text-center md:text-left">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-5xl font-bold mb-6 sm:mb-8 leading-tight text-white">
            We use half the space we build
          </h1>

          <p className="text-sm sm:text-base md:text-lg text-gray-200 leading-relaxed mb-6 sm:mb-8">
          ...
          <div>
            <button className="bg-blue-600 hover:bg-blue-700 text-white px-6 sm:px-8 py-2.5 sm:py-3 rounded-md font-medium text-sm sm:text-base transition-colors">
