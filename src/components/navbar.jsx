    ...
    <nav className="bg-white fixed w-full top-0 left-0 z-50 shadow-sm">
      <div className="container mx-auto flex items-center justify-between px-4 py-4 relative">
        ...
        <button
          ...
          className="md:hidden text-blue-600 bg-white hover:bg-white focus:outline-none text-2xl"
        >
          ☰
        </button>
        ...
        <ul className={isOpen ? "md:flex md:space-x-6 lg:space-x-8 md:items-center absolute md:static bg-white left-0 w-full md:w-auto transition-all duration-300 ease-in top-16 opacity-100 md:justify-center md:flex-1 text-center" : "md:flex md:space-x-6 lg:space-x-8 md:items-center absolute md:static bg-white left-0 w-full md:w-auto transition-all duration-300 ease-in top-[-400px] opacity-0 md:opacity-100 md:justify-center md:flex-1 text-center"}>
          ...
          {!isAuthenticated ? (
            <>
              ...
              <li className="md:hidden flex justify-center py-2">
                <button
                  onClick={handleBookAppointment}
                  className="bg-blue-600 text-white px-6 py-2 rounded-md hover:bg-blue-700 transition whitespace-nowrap"
                >
                  Book Appointment
                </button>
              </li>
            ...
            <li className="md:hidden border-t border-gray-200 mt-2 pt-2">
              <div className="flex flex-col items-center space-y-2">
                ...
                <a href="/my-consultations" className="block py-2 px-4 text-gray-700 hover:text-blue-600 w-full text-center">
                  My Consultations
                </a>
                <button 
        ...
        <div className="hidden md:flex items-center space-x-6 lg:space-x-10">
          {!isAuthenticated ? (
            <>
              ...
              <button onClick={handleBookAppointment} className="bg-blue-600 text-white px-5 py-2.5 rounded-md hover:bg-blue-700 transition whitespace-nowrap">
                Book Appointment
              </button>
            </>
          ) : (
            <>
              ...
              <div className="relative">
                <button 
                  ...
                  className="flex items-center space-x-2 px-3 py-2 border-2 border-gray-900 rounded-lg bg-white hover:bg-gray-50 transition"
                >
                  ...
                  <svg className="w-4 h-4 text-gray-900 transition-transform duration-200" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M19 9l-7 7-7-7" />
                  </svg>
                </button>
                ...
                {isUserMenuOpen && (
                  <div className="absolute right-0 mt-2 w-56 bg-white shadow-xl rounded-lg py-1 border border-gray-200">
                    ...
                    <button 
                      onClick={handleLogout} 
                      className="flex items-center w-full text-left px-4 py-2.5 text-sm text-gray-700 hover:bg-red-50 hover:text-red-600 transition-colors border-t border-gray-100 mt-1"
                    >
