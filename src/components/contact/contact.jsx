          ...
          <div>
            ...
            <div className="space-y-6">
              ...
              <button
                ...
                className="w-full bg-blue-600 hover:bg-blue-700 text-white px-6 py-3.5 rounded-lg font-medium transition-colors flex items-center justify-center gap-2 group"
              >
                Submit
