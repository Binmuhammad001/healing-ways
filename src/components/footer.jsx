  ...
  return (
    <footer className="bg-[#172641] text-white py-12 px-8 w-full">
      <div className="w-full px-8">
        {/* Main Footer Content */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1.5fr] gap-6 md:gap-8 mb-8 m-8">
          ...
          <div className="mr-8 text-center md:text-left">
            <div className="flex items-center justify-center md:justify-start mb-4">
              <img
                ...
                className="w-40 h-auto filter invert brightness-0 mr-2"
              />
            </div>
          ...
          <div className="text-center md:text-left">
            ...
            <div className="flex justify-center md:justify-start">
              <input
                ...
                className="flex-1 max-w-xs bg-white px-4 py-2 rounded-l-md text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm"
              />
        ...
        <div className="border-t border-gray-700 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-4 mb-4 md:mb-0">
              <a href="#linkedin" className="w-8 h-8 bg-gray-700 hover:bg-gray-600 rounded-full flex items-center justify-center transition">
              ...
              <a href="#facebook" className="w-8 h-8 bg-gray-700 hover:bg-gray-600 rounded-full flex items-center justify-center transition">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z" />
                </svg>
              </a>

              <a href="#twitter" className="w-8 h-8 bg-gray-700 hover:bg-gray-600 rounded-full flex items-center justify-center transition">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
