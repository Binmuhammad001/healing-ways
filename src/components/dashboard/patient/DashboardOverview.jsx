...
const DashboardOverview = ({ user, statistics, recentConsultations }) => {
      ...
      <div className="mb-8 bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg p-6 text-white">
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="mb-4 md:mb-0">
            <h2 className="text-2xl font-bold mb-2">Need Medical Consultation?</h2>
            <p className="text-blue-100">Book your consultation in just a few clicks</p>
          </div>
          <button
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-blue-600 mt-2">
                {statistics?.ongoingConsultations || 0}
              </p>
            </div>
            <div className="bg-blue-100 rounded-full p-3">
              <svg className="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-green-600 mt-2">
                {statistics?.completedConsultations || 0}
              </p>
            </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
        <div className="p-6 border-b border-gray-200 flex items-center justify-between">
          ...
          <button
            ...
            className="bg-white text-blue-600 border border-blue-600 hover:bg-blue-50 px-4 py-2 rounded-lg text-sm font-medium flex items-center transition-colors"
          >
            View All
                ...
                >
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-800">{consultation.service}</h3>
                        <p className="text-sm text-gray-600">
                          {consultation.country} • {formatDate(consultation.submittedAt)}
                        </p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
